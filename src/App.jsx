...
const ADVICE_CONTENT = [
  ...
  { title: "Stratégie", icon: <Trophy className="w-6 h-6 text-yellow-400" />, content: "Ne partez pas trop vite. Les 10 premiers km doivent paraître trop lents. Gardez 5% de réserve pour le semi-marathon." }
];
